...
p3 <- p1 + scale_fill_gradient(low = "white", high = "#ff0803") +
    labs(title = "Trump vote") 
...
p3 <- p1 + scale_fill_gradient2(low = "#ff0803", mid = "#D7A1F9",
...
p2 <- p1 + scale_fill_gradient2(low = "#ff0803",
                                mid = "#D7A1F9",
                                high = "#0000ff") +
    labs(title = "Winning margins") 
p2 + theme_map() + labs(fill = "Percent")
